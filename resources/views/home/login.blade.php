				...
				<div  class="loginform">
					...
					<div class="tab-content tab-wraped">
						...
						<div id="profile" class="tab-pane  active">
							...
							<form action="{{route('home_dologin')}}" method="post" enctype="multipart/form-data"  class="sui-form">
							@csrf
								<div class="input-prepend"><span class="add-on loginname"></span>
									<input id="prependedInput" type="text" name="uname" placeholder="用户名/手机号" class="span2 input-xfat">
								</div>
								@if($errors->has('uname'))
								<p class="errors">{{$errors->first('uname')}}</p>
								@endif
							...
							{!! Geetest::render() !!}
								...
								<div class="logined">
									<input type="submit"  class="sui-btn btn-block btn-xlarge btn-danger" value="登陆">
								</div>
							</form>
							<div class="otherlogin">
								...
								<span class="register"><a href="{{route('home_register')}}" target="_blank">立即注册</a></span>
							</div>
						</div>
					</div>
				</div>
