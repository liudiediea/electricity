			...
			<div class="yui3-g SortList ">
				<div class="yui3-u Left all-sort-list">
					<div class="all-sort-list2">
						@foreach($sort as $v)
						<div class="item bo">
							<h3><a href="{{route('goods_list',['cat1_id'=>$v['id']])}}">{{$v['cat_name']}}</a></h3>

							<div class="item-list clearfix">
								@foreach($v['level2'] as $a)
								<div class="subitem">
									<dl class="fore1">
										<dt><a href="{{route('goods_list',['cat2_id'=>$a['id']])}}">{{$a['cat_name']}}</a></dt>
										@foreach($a['level3'] as $b)
										<em><dd><a href="{{route('goods_list',['cat3_id'=>$b['id']])}}">{{$b['cat_name']}}</a></dd></em>
										@endforeach
									</dl>
								</div>
								@endforeach
