				...
				<div class="py-container">
					<div class="yui3-g Logo">
						<div class="yui3-u Left logoArea">
							<a class="logo-bd" title="品优购" href="{{route('home_index')}}" target="_blank"></a>
						</div>
				...
				<div class="goods-list">
					<ul class="yui3-g">
						...
						<li class="yui3-u-1-5">
							<div class="list-wrap">
								<div class="p-img">
									<a href="{{route('item',['id'=>$v->id])}}">
									<img src="{{Storage::url($v->logo)}}" />
									</a>
								</div>
								<div class="price">
									<strong>
								...
								<div class="operate">
									<a href="{{route('cart')}}" class="sui-btn btn-bordered btn-danger">加入购物车</a>
