	...
	<div class=" page-content clearfix">
		<div id="products_style">
			...
			<div class="border clearfix">
				<span class="l_f">
					<a href="{{route('goods_add')}}" title="添加商品" class="btn btn-warning Order_form"><i class="icon-plus"></i>添加商品</a>
					...
					<table class="table table-striped table-bordered table-hover" id="sample-table">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<img src="{{Storage::url($v->logo) }}"  width="130"/>
								</td>
								<td width="100px">{{$v->name}}</td>
								<td width="100px">{{$v->cat1_id}}</td>
								...
								<td class="td-manage">
									...
									<a title="编辑" href="{{route('goods_edit',['id'=>$v->id])}}" class="btn btn-xs btn-info"><i
