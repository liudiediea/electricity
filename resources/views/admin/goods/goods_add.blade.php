        ...
        <h1>添加商品</h1>
            ...
            <div class="layui-form-item">
                ...
                <fieldset class="layui-elem-field layui-field-title" style="margin-top: 30px;">
                        <legend>上传商品LOGO</legend>
                </fieldset>
                 <div class="layui-upload">
                    <label for="cover" type="button" class="layui-btn" id="test2">上传商品LOGO</label> 
                                        ...
                                        <div class="div_contentlist">
                                            ...
                                            <div class="layui-col-md12">
                                                ...
                                                <ul class="Father_Item1" style="padding-left: 20px; background-color: #F8F8F8;">
                                                    ...
                                                    <li class="li_width">
                                                        <label>
                                                            <input id="Checkbox9" type="checkbox" class="chcBox_Width" value="尺寸-150/80A" />150/80A
                                                        </label>
                                                    </li>
                                                    <li class="li_width">
                                                        <label>
