...
<form action="{{route('insert_article')}}" method="post" enctype="multipart/form-data">
@csrf
 <div class="article_style">
    <div class="add_content" id="form-article-add">  
     <ul>
      ...
      <span class="formControls col-10"><input  name="introduction" type="text" id="form-field-1" class="col-xs-10 col-sm-6 "></span>
      </li>
      ...
      <li class="clearfix"><label class="label_name">显示时间</label>
       ...
       <label><input name="is_show" type="radio" class="ace" onclick="Enable()" value="显示"><span class="lbl">显示</span></label>&nbsp;
       <label><input name="is_show" type="radio" class="ace" onclick="closes()" value="不显示"><span class="lbl">不显示</span></label></span>
