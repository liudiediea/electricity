...
<body>
	<form action="{{route('role_update',['id'=>$role_name->id]) }}" method="post">
		@csrf
		...
		<div class="left_Competence_add">
			...
			<div class="Competence_add">
				<div class="form-group"><label class="col-sm-2 control-label no-padding-right" for="form-field-1">角色名称 </label>
					<div class="col-sm-9"><input type="text" id="form-field-1" value="{{$role_name->role_name}}" name="role_name" class="col-xs-10 col-sm-5"></div>
				</div>
			</div>
		</div>
		<!--权限分配-->
		<div class="Assign_style">
			...
			<div class="Select_Competence">
				...
				<dl class="permission-list">
					<dt>
						<label class="middle">				
								<input type="checkbox" name="pri_id[]" value="{{$v['id']}}" class="ace"  >
					...
					<dd>
						<dl class="cl permission-list2">
							...
							<dd>
									...
									<label class="middle"><input type="checkbox" @if(in_array($a['id'],$pri_id)) echo checked @endif value="{{$a['id']}}" name="pri_id[]" class="ace"  >
