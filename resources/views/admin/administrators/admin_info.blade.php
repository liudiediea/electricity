...
<div class="clearfix">
     ...
     <div class="type_title">管理员信息 </div>  
      ...
      @foreach($admin as $v)
        <div class="form-group"><label class="col-sm-3 control-label no-padding-right" for="form-field-1">用户名： </label>
          <div class="col-sm-9"><input type="text" name="username" id="website-title" value="{{$v->username}}" class="col-xs-7 text_info" disabled="disabled">
          ...
          <div class="col-sm-9">
          <span class="sex">{{$v->sex}}</span>
            <div class="add_sex">
            <label><input name="sex" type="radio" value="保密" class="ace" @if($v->sex='保密') checked @endif><span class="lbl">保密</span></label>&nbsp;&nbsp;
            <label><input name="sex" type="radio" value="男" class="ace" @if($v->sex='男') checked @endif><span class="lbl">男</span></label>&nbsp;&nbsp;
            <label><input name="sex" type="radio" value="女" class="ace" @if($v->sex='女') checked @endif><span class="lbl">女</span></label>
            </div>
           </div>
          </div>
          <div class="form-group"><label class="col-sm-3 control-label no-padding-right" for="form-field-1">年龄： </label>
          <div class="col-sm-9"><input type="text" name="age" id="website-title" value="{{$v->age}}" class="col-xs-7 text_info" disabled="disabled"></div>
          </div>
          <div class="form-group"><label class="col-sm-3 control-label no-padding-right" for="form-field-1">移动电话： </label>
          <div class="col-sm-9"><input type="text" name="mobile" id="website-title" value="{{$v->mobile}}" class="col-xs-7 text_info" disabled="disabled"></div>
          </div>
          <div class="form-group"><label class="col-sm-3 control-label no-padding-right" for="form-field-1">电子邮箱： </label>
          <div class="col-sm-9"><input type="text" name="email" id="website-title" value="{{$v->email}}" class="col-xs-7 text_info" disabled="disabled"></div>
          </div>
          <div class="form-group"><label class="col-sm-3 control-label no-padding-right" for="form-field-1">QQ： </label>
          <div class="col-sm-9"><input type="text" name="QQ" id="website-title" value="{{$v->QQ}}" class="col-xs-7 text_info" disabled="disabled"> </div>
          </div>
           <div class="form-group"><label class="col-sm-3 control-label no-padding-right" for="form-field-1">权限： </label>
          <div class="col-sm-9" > <span>{{$v->role_name}}</span></div>
          </div>
          ...
          @endforeach
           ...
           <div class="Button_operation clearfix"> 
				<input onclick="modify();" class="btn btn-danger radius" type="button" value="修改信息">
 ...
 <!--修改密码样式-->
         <div class="change_Pass_style" id="change_Pass">
            <ul class="xg_style">
             <li><label class="label_name">原&nbsp;&nbsp;密&nbsp;码</label><input name="oldpassword" type="password" class="" id="password"></li>
             <li><label class="label_name">新&nbsp;&nbsp;密&nbsp;码</label><input name="newpassword" type="password" class="" id="Nes_pas"></li>
             <li><label class="label_name">确认密码</label><input name="repassword" type="password" class="" id="c_mew_pas"></li>
