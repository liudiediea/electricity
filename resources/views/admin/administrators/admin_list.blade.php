	...
	@foreach($admin as $v)
     <tr>
      ...
      <td class="td-manage">
        ...
        <a title="删除" href="{{route('del_admin',['id'=>$v->id])}}"   onclick="member_del(this,'1')" class="btn btn-xs btn-warning" ><i class="fa fa-trash  bigger-120"></i></a>
       </td>
     </tr>
 ...
 <div id="add_administrator_style" class="add_menber" style="display:none">
	...
	@csrf
		...
		<div class="form-group">
			...
			<div class="formControls">
			<input type="text" placeholder="年龄" name="age" autocomplete="off" value="" class="input-text" datatype="*1-3" nullmsg="年龄不能为空">
			</div>
			<div class="col-4"> <span class="Validform_checktip"></span></div>
		</div>
		...
		<div class="form-group">
			...
			<div class="formControls ">
				<input type="text" class="input-text" value="" placeholder="" id="user-tel" name="QQ" datatype="m" nullmsg="QQ不能为空">
			</div>
			<div class="col-4"> <span class="Validform_checktip"></span></div>
		</div>
		<div class="form-group">
