...
<body>
 <div class="margin clearfix">
   <div class="border clearfix">
       <span class="l_f">
        <a href="{{route('role_add')}}" id="Competence_add" class="btn btn-warning" title="添加角色"><i class="fa fa-plus"></i> 添加角色</a>
       ...
       <table id="sample-table-1" class="table table-striped table-bordered table-hover">
         ...
         <tr>
				...
				<td>
                 ...
                 <a title="删除"  href="{{route('role_del',['id'=>$v->id]) }}"  onclick="return confirm('确定要删除吗？')"  class="btn btn-xs btn-warning" ><i class="fa fa-trash  bigger-120"></i></a>
				</td>
			   </tr>
			  	@endforeach										
		      </tbody>
